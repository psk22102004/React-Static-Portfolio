      ...
      <section id='Home'>
        <div className=' mx-auto p-4 md:p-10 flex flex-col justify-center items-center space-y-6 md:space-y-8 lg:space-y-14'>
          ...
          <div className='btnContainer flex space-x-6 lg:space-x-10'>
            <button className='border px-3 lg:px-8 py-2 lg:py-3 rounded-xl font-semibold bg-dgreen text-black hover:bg-dblack hover:text-dgreen'><a href='#Contact'> Get In Touch</a></button>
            <button className='border px-3 lg:px-8 py-2 lg:py-3 rounded-xl font-semibold bg-dblack text-dgreen hover:bg-sblack '><a href='#Projects'> View Projects </a></button>
          </div>
        </div>
      </section>
    </div>

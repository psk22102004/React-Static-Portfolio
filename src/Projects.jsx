...
const Projects = () => {
    ...
    const projectsArray = [
        { iconSrc: 'cardIcons/shopping.png', title: 'Social2Shelf', projectLink: 'https://social2-shelf.vercel.app/', illustration: 'illustrations/shopping.png', projectImg: ['projectImages/shop1.png', 'projectImages/shop2.png', 'projectImages/shop3.png', 'projectImages/shop4.png'], desc: 'lorem ipsum Lorem ipsum dolor sit Et atque aliquam, voluptatem aspernatur repellat voluptates' },
        { iconSrc: 'cardIcons/court.png', title: 'EquiLaw', projectLink: 'https://equilaw.vercel.app/', illustration: 'illustrations/web-ill1.png', projectImg: ['projectImages/equilawCover.png', 'projectImages/equilawCover2.png', 'projectImages/equilawCover3.png', 'projectImages/equilawCover4.png', 'projectImages/equilawCover5.png'], desc: 'lorem ipsum Lorem ipsum dolor sit Et atque aliquam, voluptatem aspernatur repellat voluptates' },
        { iconSrc: 'cardIcons/mongoIcon.png', title: 'MongoDb Lab', projectLink: 'https://mongo-db-mini-playground.vercel.app/', illustration: 'illustrations/mongoIllustration.png', projectImg: ['projectImages/mongo1.png', 'projectImages/mongo2.png', 'projectImages/mongo3.png'], desc: 'lorem ipsum Lorem ipsum dolor sit Et atque aliquam, voluptatem aspernatur repellat voluptates' },
        { iconSrc: 'cardIcons/doctor.png', title: '800 Doctors', projectLink: 'https://www.800doctor.com/' , illustration: 'illustrations/doctorIllustration.png', projectImg: ['projectImages/doctor1.png', 'projectImages/doctor2.png', 'projectImages/doctor3.png', 'projectImages/doctor4.png', 'projectImages/doctor5.png', 'projectImages/doctor6.png', 'projectImages/doctor7.png', 'projectImages/doctor8.png'], desc: 'lorem ipsum Lorem ipsum dolor sit Et atque aliquam, voluptatem aspernatur repellat voluptates' },
                        ...
                        <div key={index} className='border border-black p-8 md:p-6 space-y-6 rounded-lg bg-[#96c2fa] shadow-md shadow-dgreen hover:shadow-lg hover:shadow-dgreen col-span-12 md:col-span-6 lg:col-span-4'>
                            ...
                            <div className='flex flex-col text-black space-y-6'>
                                <div className='flex items-center'>
                                    ...
                                    <h1 className='font-bold text-3xl tracking-wide h-max'> <a target='_blank' href={ele.projectLink}> {ele.title} </a> </h1>
                                </div>
